    ...
    private unsafe IImGuiBackend InitBackend(IDXGISwapChain* swapChain)
    {
        ...
        using (Timings.Start("IM Scene Init"))
        {
            ...
            if (configuration.SavedStyles == null ||
                configuration.SavedStyles.All(x => x.Name != StyleModelV1.DalamudStandardSoil.Name || configuration.SavedStyles.Count < 3))
            {
                configuration.SavedStyles = new List<StyleModel>
                    { StyleModelV1.DalamudStandardSoil, StyleModelV1.DalamudStandard, StyleModelV1.DalamudClassic };
                configuration.ChosenStyle = StyleModelV1.DalamudStandardSoil.Name;
            }
            else if (configuration.SavedStyles[1].Name != StyleModelV1.DalamudStandard.Name)
            {
                configuration.SavedStyles.Insert(1, StyleModelV1.DalamudStandard);
            }

            configuration.SavedStyles[0] = StyleModelV1.DalamudStandardSoil;
            configuration.SavedStyles[1] = StyleModelV1.DalamudStandard;
            configuration.SavedStyles[2] = StyleModelV1.DalamudClassic;
